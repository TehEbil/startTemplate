angular.module('MetronicApp').factory('vsEmbeddedValidatorsInjector', ['$injector', function($injector) {
  var validatorsHash = [];
...
angular.module('MetronicApp').service('vsValidatorFactory', ['vsEmbeddedValidatorsInjector', function(vsEmbeddedValidatorsInjector) {
  /**
...
angular.module('MetronicApp').directive('vsAutocompleteValidator', ['vsValidatorFactory', function(vsValidatorFactory) {
  /**
...
angular.module('MetronicApp').factory('vsGooglePlace', ['vsGooglePlaceUtility', function(vsGooglePlaceUtility) {
...
angular.module('MetronicApp').factory('vsStreetAddress', ['vsGooglePlaceUtility', function(vsGooglePlaceUtility) {
